...
import { TelegramUserRepositoryV3Service } from '@database/user-repository/user-repository.v3.service';
import { PrismaService } from '@database/prisma.service';

describe('TelegramUserRepositoryV3Service', () => {
  let userRepository: TelegramUserRepositoryV3Service;
  ...
  beforeEach(async () => {
    ...
    userRepository = module.get<TelegramUserRepositoryV3Service>(TelegramUserRepositoryV3Service);
